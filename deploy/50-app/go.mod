...
require (
	...
	github.com/go-git/go-billy/v6 v6.0.0-20250702072542-cc6353624d14 // indirect
	...
	github.com/kemadev/ci-cd v0.5.0 // indirect
	github.com/kemadev/go-framework v0.0.0-20250703121255-f9d7063b499c // indirect
